...
const createPrompt = (contentArray: any) => {
    return "You are very good at generating titles for the low vision readers. Can you please create the title for this content which are grouped: " + contentArray
}
